  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const taskPayload = {
        ...
        assignedTo: (lead as any).contactOwnerEmail || (lead as any).contact_owner_email || (lead as any).assignedTo || user?.email || '',
        assigned_to: (lead as any).contactOwnerEmail || (lead as any).contact_owner_email || (lead as any).assignedTo || user?.email || '',
        contactOwnerEmail: (lead as any).contactOwnerEmail || (lead as any).contact_owner_email || user?.email || '',
        contact_owner_email: (lead as any).contactOwnerEmail || (lead as any).contact_owner_email || user?.email || '',
        stage: 'CALLBACK',
