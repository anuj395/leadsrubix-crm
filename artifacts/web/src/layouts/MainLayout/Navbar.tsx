...
const breadcrumbMap: Record<string, string[]> = {
    ...
    '/leads/inquiries': ['Home', 'Leads', 'Inbound Inquiries'],
    '/leads/contacts': ['Home', 'Leads', 'Leads & Contacts'],
    '/leads/contacts/new': ['Home', 'Leads', 'Leads & Contacts', 'Add Lead'],
    '/leads/tasks': ['Home', 'Leads', 'Tasks & Follow-ups'],
    '/leads/tasks-list': ['Home', 'Leads', 'Tasks & Follow-ups'],
    '/leads/tasks/new': ['Home', 'Leads', 'Tasks & Follow-ups', 'Add Task'],
    ...
    '/configuration/whatsapp': ['Home', 'Configuration', 'Notifications & Automation'],
    '/integrations/whatsapp': ['Home', 'Integrations', 'Notifications & Automation'],
    '/configuration/notifications': ['Home', 'Configuration', 'Notifications & Automation'],
    '/integrations/notifications': ['Home', 'Integrations', 'Notifications & Automation'],
