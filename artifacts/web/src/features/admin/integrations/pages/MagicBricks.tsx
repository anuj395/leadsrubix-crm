  ...
  return (
    ...
    >
      ...
      <AppCard
        ...
        subtitle="Configure automatic lead capturing from your MagicBricks advertisements."
        fullHeight
        action={
            ...
            <Grid size={{ xs: 12, md: 5 }}>
              <Paper variant="outlined" sx={{ p: 3, borderRadius: 3, bgcolor: '#f8fafc', borderColor: 'divider' }}>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 2, lineHeight: 1.6, fontSize: '0.85rem' }}>
                  Once the MagicBricks team configures the payload mapping on their backend, active listing leads immediately stream into your CRM.
                </Typography>
                <Typography variant="body2" color="text.secondary" sx={{ mb: 2.5, lineHeight: 1.6, fontSize: '0.85rem' }}>
                  Buyer name, phone number, project title, and customer comments are automatically mapped to CRM contacts and tasks.
                </Typography>
                <Button
                  variant="outlined"
                  color="primary"
                ...
                >
                  View MagicBricks Field Mappings & Guide
                </Button>
              </Paper>
            </Grid>
          </Grid>
      ...
      <TestLeadModal
        ...
        platformKey="magicbricks"
        platformName="MagicBricks"
        token={apiKey}
