...
export default function MagicBricksPage() {
  ...
  const webhookUrl = 'https://api.leadsrubix.com/api/v1/webhooks/magicbricks'
  ...
  return (
    ...
    >
      ...
      <AppCard title="MagicBricks Integration" subtitle="Configure automatic lead capturing from your MagicBricks advertisements." fullHeight>
        <Box sx={{ flex: 1, minHeight: 0, overflowY: 'auto', mt: 2, pr: 1 }}>
          <Typography variant="h6" sx={{ fontWeight: 700, mb: 1, color: 'text.primary', fontSize: '1.25rem' }}>
            Receive New Leads from MagicBricks Directly in Your Leads Rubix Account
          </Typography>
          <Typography variant="body2" color="text.secondary" sx={{ mb: 4, lineHeight: 1.6 }}>
            To set up the integration, copy and forward these integration details to your MagicBricks Account Manager:
          </Typography>
              ...
              <Paper variant="outlined" sx={{ p: 3, borderRadius: 3, border: '1px solid', borderColor: 'divider', bgcolor: 'background.paper' }}>
                ...
                <Box sx={{ mb: 3 }}>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ bgcolor: 'grey.50', p: 2, borderRadius: 2, border: '1px solid', borderColor: 'grey.200' }}>
                    "Please configure my MagicBricks account to send all incoming campaign leads directly to my CRM via Webhook."
                  </Typography>
                </Box>

                <Box sx={{ mb: 3 }}>
                  <Typography variant="body2" sx={{ fontWeight: 600, mb: 1 }}>
                    My MagicBricks Login ID
                  </Typography>
                  <Typography variant="body2" sx={{ fontFamily: 'monospace', fontWeight: 600, color: 'primary.main', bgcolor: '#eff6ff', p: 1.5, borderRadius: 2, border: '1px dashed #bfdbfe' }}>
                    YOUR_USER_ID
                  </Typography>
                </Box>
            ...
            <Grid size={{ xs: 12, md: 5 }}>
              <Paper variant="outlined" sx={{ p: 3, borderRadius: 3, bgcolor: '#f8fafc', borderColor: 'divider' }}>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 2, lineHeight: 1.6 }}>
                  Once the MagicBricks team configures the payload mapping on their backend, active listing leads will immediately begin streaming into your Leads Rubix panel.
                </Typography>
                <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.6 }}>
                  This setup is fully database-integrated and does not require manual token management once created.
                </Typography>
              </Paper>
            </Grid>
          </Grid>
