...
router.get('/admin/email-settings/quotas', authenticate, permit('superAdmin'), emailSettingsCtrl.getAdminQuotas);
router.put('/admin/email-settings/quotas/:orgId', authenticate, permit('superAdmin'), emailSettingsCtrl.updateAdminQuota);
