...
const DEFAULT_SIDEBAR_CONFIGS = [
  {
    ...
    roles: {
      admin: [
        ...
        { key: 'leads.contact', name: 'Qualified Leads & Contacts', route: '/leads/contacts', icon: 'contact', module: 'leads' },
...
async function seedAdminAnalyticsSidebarPermissions() {
  ...
  const CANONICAL_MENUS = [
    ...
    { key: 'leads.inquiries', name: 'Raw Inquiries', route: '/leads/inquiries', icon: 'contact', parentKey: 'leads', order: 4.05 },
    { key: 'leads.contact', name: 'Qualified Leads & Contacts', route: '/leads/contacts', icon: 'contact', parentKey: 'leads', order: 4.1 },
