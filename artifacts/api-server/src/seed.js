...
const SCREEN_DEFAULTS = [
  {
    ...
    fields: [
      { field_key: 'firstName',         label: 'First Name',          type: 'text',     is_required: false, order: 1 },
      ...
      { field_key: 'alternateNo',       label: 'Alternate Number',    type: 'text',     is_required: false, order: 5 },
      { field_key: 'status',            label: 'Status',              type: 'badge',    is_required: false, order: 6 },
      { field_key: 'leadType',          label: 'Lead Type',           type: 'select',   is_required: false, order: 7, dropdown_source: 'api', dropdown_api: '/api/options/leadType' },
      ...
      { field_key: 'propertyType',      label: 'Property Type',       type: 'select',   is_required: true,  order: 9, dropdown_source: 'api', dropdown_api: '/api/options/propertyType' },
      { field_key: 'propertyStage',     label: 'Property Stage',      type: 'select',   is_required: true,  order: 10, dropdown_source: 'api', dropdown_api: '/api/options/propertyStage' },
      { field_key: 'budget',            label: 'Budget',              type: 'select',   is_required: true,  order: 11, dropdown_source: 'api', dropdown_api: '/api/options/budget' },
      { field_key: 'propertySubType',   label: 'Property Sub Type',   type: 'select',   is_required: true,  order: 12, dropdown_source: 'api', dropdown_api: '/api/options/propertySubType' },
      { field_key: 'source',            label: 'Lead Source',         type: 'select',   is_required: true,  order: 13, dropdown_source: 'api', dropdown_api: '/api/options/source' },
      { field_key: 'contactOwnerEmail', label: 'Contact Owner Email', type: 'text',     is_required: false, order: 14 },
