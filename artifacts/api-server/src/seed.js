...
const SCREEN_DEFAULTS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { field_key: 'contactNumber', label: 'Phone Number', type: 'phone', is_required: true, order: 2 },
      { field_key: 'project', label: 'Project Name', type: 'select', dropdown_source: 'api', dropdown_api: 'options/projectName', is_required: true, order: 3 },
      { field_key: 'location', label: 'Location', type: 'select', dropdown_source: 'api', dropdown_api: 'options/location', is_required: false, order: 4 },
      { field_key: 'unitNumber', label: 'Unit / Flat Number', type: 'text', is_required: false, order: 5 },
      { field_key: 'bookingAmount', label: 'Booking Amount', type: 'number', is_required: true, order: 6 },
      { field_key: 'bookingDate', label: 'Booking Date', type: 'date', is_required: true, order: 7 },
      { field_key: 'status', label: 'Booking Status', type: 'select', dropdown_source: 'static', options: ['BOOKED', 'CONFIRMED', 'CANCELLED'], default_value: 'BOOKED', is_required: true, order: 8 },
      { field_key: 'branch', label: 'Branch', type: 'select', dropdown_source: 'api', dropdown_api: 'options/branches', is_required: false, order: 9 },
      { field_key: 'team', label: 'Assigned Team', type: 'select', dropdown_source: 'api', dropdown_api: 'options/teams', is_required: false, order: 10 },
      { field_key: 'notes', label: 'Notes', type: 'textarea', is_required: false, order: 11 },
    ],
  },
  {
    key: 'interested',
