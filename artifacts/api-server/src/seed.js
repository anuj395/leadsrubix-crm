...
const DEFAULT_SIDEBAR_CONFIGS = [
  {
    ...
    roles: {
      admin: [
        ...
        { key: 'leads.contact', name: 'Leads & Contacts', route: '/leads/contacts', icon: 'contact', module: 'leads' },
        { key: 'leads.tasks', name: 'Tasks & Follow-ups', route: '/leads/tasks', icon: 'tasks', module: 'leads' },
        { key: 'leads.call', name: 'Call Logs', route: '/leads/call-logs', icon: 'call', module: 'leads' },
...
const SCREEN_DEFAULTS = [
  ...
  },
  {
    key: 'tasks',
    name: 'Tasks',
    description: 'Lead / follow-up tasks & scheduling',
    fields: [
      {
        field_key: 'contactId',
      ...
      },
      {
        ...
        is_required: true,
        order: 2,
        dropdown_source: 'static',
        options: ['Call Back', 'Site Visit', 'Meeting', 'Online Demo', 'Follow-up', 'Document Collection / KYC'],
        default_value: 'Call Back',
        is_form_visible: true,
      ...
      },
      {
        ...
        order: 5,
        dropdown_source: 'api',
        dropdown_api: 'options/organizationUsers',
        is_form_visible: true,
        is_table_visible: true,
      },
      {
        field_key: 'callbackReason',
      ...
      // Table & relational metadata (hidden in creation form, visible in table)
      { field_key: 'customerName', label: 'Customer Name', type: 'text', is_required: false, order: 8, is_form_visible: false, is_table_visible: true },
      { field_key: 'contactNumber', label: 'Contact Number', type: 'phone', is_required: false, order: 9, is_form_visible: false, is_table_visible: true },
      { field_key: 'projectName', label: 'Project Name', type: 'text', is_required: false, order: 10, is_form_visible: false, is_table_visible: true },
      { field_key: 'status', label: 'Status', type: 'badge', is_required: false, order: 11, default_value: 'PENDING', is_form_visible: false, is_table_visible: true },
      { field_key: 'stage', label: 'Stage', type: 'text', is_required: false, order: 12, is_form_visible: false, is_table_visible: false },
      { field_key: 'source', label: 'Source', type: 'text', is_required: false, order: 13, is_form_visible: false, is_table_visible: false },
      { field_key: 'location', label: 'Location', type: 'text', is_required: false, order: 14, is_form_visible: false, is_table_visible: false },
      { field_key: 'budget', label: 'Budget', type: 'text', is_required: false, order: 15, is_form_visible: false, is_table_visible: false },
      { field_key: 'createdAt', label: 'Created At', type: 'date', is_required: false, order: 16, is_form_visible: false, is_table_visible: false },
      // Internal telemetry & audit fields (completely hidden everywhere)
      { field_key: 'latitude', label: 'Latitude', type: 'number', is_required: false, order: 20, is_form_visible: false, is_table_visible: false },
      { field_key: 'longitude', label: 'Longitude', type: 'number', is_required: false, order: 21, is_form_visible: false, is_table_visible: false },
      { field_key: 'transferStatus', label: 'Transfer Status', type: 'text', is_required: false, order: 22, is_form_visible: false, is_table_visible: false },
      { field_key: 'completedAt', label: 'Completed At', type: 'date', is_required: false, order: 23, is_form_visible: false, is_table_visible: false },
      { field_key: 'uniqueMeeting', label: 'Unique Meeting', type: 'text', is_required: false, order: 24, is_form_visible: false, is_table_visible: false },
      { field_key: 'uniqueSiteVisit', label: 'Unique Site Visit', type: 'text', is_required: false, order: 25, is_form_visible: false, is_table_visible: false },
    ],
  },
  {
    key: 'users',
  ...
  },
  {
    ...
    fields: [
      ...
      { field_key: 'customerName', label: 'Customer Name', type: 'text', is_required: false, order: 2, is_form_visible: false, is_table_visible: true },
      { field_key: 'contactNumber', label: 'Phone Number', type: 'phone', is_required: false, order: 3, is_form_visible: false, is_table_visible: true },
      { field_key: 'project', label: 'Project Name', type: 'select', dropdown_source: 'api', dropdown_api: 'options/projectName', is_required: true, order: 4 },
      { field_key: 'location', label: 'Location', type: 'select', dropdown_source: 'api', dropdown_api: 'options/location', is_required: false, order: 5 },
      { field_key: 'unitNumber', label: 'Unit / Flat Number', type: 'text', is_required: false, order: 6 },
      { field_key: 'bookingAmount', label: 'Booking Amount', type: 'number', is_required: true, order: 7 },
      { field_key: 'bookingDate', label: 'Booking Date', type: 'date', is_required: true, order: 8 },
      { field_key: 'status', label: 'Booking Status', type: 'select', dropdown_source: 'static', options: ['BOOKED', 'CONFIRMED', 'CANCELLED'], default_value: 'BOOKED', is_required: true, order: 9 },
      { field_key: 'branch', label: 'Branch', type: 'select', dropdown_source: 'api', dropdown_api: 'options/branches', is_required: false, order: 10 },
      { field_key: 'team', label: 'Assigned Team', type: 'select', dropdown_source: 'api', dropdown_api: 'options/teams', is_required: false, order: 11 },
      { field_key: 'notes', label: 'Notes', type: 'textarea', is_required: false, order: 12 },
    ],
  },
  {
    key: 'interested',
    ...
    fields: [
      ...
      { field_key: 'taskType', label: 'Next Follow Up Type', type: 'select', is_required: true, order: 5, dropdown_source: 'static', options: ['Call Back', 'Site Visit', 'Meeting', 'Online Demo', 'Follow-up', 'Document Collection / KYC'], default_value: 'Call Back' },
  ...
  },
  {
    ...
    fields: [
      { field_key: 'callBackReason', label: 'Call Back Reason', type: 'select', is_required: true, order: 1, dropdown_source: 'static', options: ['Customer Busy / Call Later', 'Price / Budget Discussion', 'Location / Layout Clarification', 'Site Visit Booking', 'Decision Maker Unavailable', 'Ringing / Not Picked', 'Other'] },
  ...
  },
  {
    ...
    fields: [
      ...
      { field_key: 'title', label: 'Deal Title', type: 'text', is_required: true, order: 2 },
      { field_key: 'amount', label: 'Deal Value', type: 'number', is_required: true, order: 3 },
      { field_key: 'stage', label: 'Stage', type: 'select', dropdown_source: 'api', dropdown_api: 'options/dealStages', is_required: true, order: 4 },
      { field_key: 'probability', label: 'Probability %', type: 'number', is_required: false, order: 5 },
      { field_key: 'expectedCloseDate', label: 'Expected Close Date', type: 'date', is_required: false, order: 6 },
      { field_key: 'contactName', label: 'Contact Person', type: 'text', is_required: false, order: 7, is_form_visible: false, is_table_visible: true },
      {
        field_key: 'ownerName',
        label: 'Owner',
        type: 'select',
      ...
      { field_key: 'notes', label: 'Notes', type: 'textarea', is_required: false, order: 9 },
      {
        field_key: 'lostReason',
        label: 'Lost Reason',
        type: 'select',
        dropdown_source: 'static',
        options: ['Not Budget Fit', 'Bought Competitor Property', 'Requirement Changed', 'Delayed Purchase', 'Other'],
        is_required: false,
        order: 10,
        is_form_visible: true,
        is_table_visible: true,
  ...
  },
  {
    ...
    fields: [
      ...
      { field_key: 'projectStatus', label: 'Property Status', type: 'select', dropdown_source: 'api', dropdown_api: 'options/propertyStatus', options: ['Launched', 'Pre Launch', 'Under Construction', 'Ready to Move', 'Intermediate Occupation'], is_required: true, order: 10 },
    ]
  },
  {
  ...
  },
  {
    ...
    fields: [
      { field_key: 'propertyType', label: 'Property Type', type: 'select', dropdown_source: 'api', dropdown_api: 'options/resourcePropertyTypes?display=propertyType', is_required: true, order: 1 },
...
const INDUSTRY_MENU_OVERRIDES = {
  temp0002: {
    ...
    'leads': 'Customers',
    'leads.inquiries': 'Raw Customer Inquiries',
    'leads.contact': 'Customer Inquiries & Leads',
  ...
  temp0006: {
    ...
    'tool.areaConverter': 'Bandwidth Converter',
...
async function seedAdminAnalyticsSidebarPermissions() {
  ...
  const CANONICAL_MENUS = [
    ...
    { key: 'leads.inquiries', name: 'Inbound Inquiries', route: '/leads/inquiries', icon: 'contact', parentKey: 'leads', order: 4.05 },
    { key: 'leads.contact', name: 'Leads & Contacts', route: '/leads/contacts', icon: 'contact', parentKey: 'leads', order: 4.1 },
    { key: 'leads.tasks', name: 'Tasks & Follow-ups', route: '/leads/tasks', icon: 'tasks', parentKey: 'leads', order: 4.2 },
    { key: 'leads.call', name: 'Call Logs', route: '/leads/call-logs', icon: 'call', parentKey: 'leads', order: 4.3 },
    ...
    { key: 'deals', name: 'Deals & Pipeline', route: '/leads/deals-list', icon: 'deals', parentKey: null, order: 5 },
