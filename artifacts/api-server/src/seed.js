...
const DEFAULT_SIDEBAR_CONFIGS = [
  {
    ...
    roles: {
      admin: [
        ...
        { key: 'leads.contact', name: 'Qualified Leads & Contacts (Tier 2)', route: '/leads/contacts', icon: 'contact', module: 'leads' },
...
const INDUSTRY_MENU_OVERRIDES = {
  temp0002: {
    ...
    'leads': 'Customers',
    'leads.inquiries': 'Raw Customer Inquiries (Tier 1)',
    'leads.contact': 'Customer Inquiries & Leads (Tier 2)',
  ...
  temp0003: {
    ...
    'leads': 'Patients',
    'leads.inquiries': 'Raw Patient Inquiries (Tier 1)',
    'leads.contact': 'Patient Inquiries & Leads (Tier 2)',
  ...
  temp0004: {
    ...
    'leads': 'Students',
    'leads.inquiries': 'Raw Student Inquiries (Tier 1)',
    'leads.contact': 'Student Inquiries & Leads (Tier 2)',
  ...
  temp0005: {
    ...
    'leads': 'Clients',
    'leads.inquiries': 'Raw Investor Inquiries (Tier 1)',
    'leads.contact': 'Investor Inquiries & Leads (Tier 2)',
  ...
  temp0006: {
    ...
    'leads': 'Accounts',
    'leads.inquiries': 'Raw Client Inquiries (Tier 1)',
    'leads.contact': 'Client Inquiries & Leads (Tier 2)',
  ...
  temp0007: {
    ...
    'leads': 'Dealers',
    'leads.inquiries': 'Raw Dealer Inquiries (Tier 1)',
    'leads.contact': 'Distributor Inquiries & Leads (Tier 2)',
...
async function seedAdminAnalyticsSidebarPermissions() {
  ...
  const CANONICAL_MENUS = [
    ...
    { key: 'leads.inquiries', name: 'Raw Inquiries (Tier 1)', route: '/leads/inquiries', icon: 'contact', parentKey: 'leads', order: 4.05 },
    { key: 'leads.contact', name: 'Qualified Leads & Contacts (Tier 2)', route: '/leads/contacts', icon: 'contact', parentKey: 'leads', order: 4.1 },
    ...
    { key: 'deals', name: 'Deals & Pipeline (Tier 3)', route: '/leads/deals-list', icon: 'deals', parentKey: null, order: 5 },
